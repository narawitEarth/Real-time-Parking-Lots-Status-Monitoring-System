...
<nav class="navbar">
  <div class="container" id="navbar">
    ...
    <a class="navbar-brand" onclick="w3_open()">☰</a>
...
<nav class="navbar-brand" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
    <a href="javascript:void(0)" onclick="w3_close()"
    class="w3-bar-item w3-button" style="margin-left:5%">Close Menu ||</a>
