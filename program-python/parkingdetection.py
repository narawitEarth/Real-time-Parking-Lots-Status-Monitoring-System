...
#http://192.168.137.23:45699/videostream.cgi?user=admin&pwd=TApop123  lot2
    ...
    cap = cv2.VideoCapture('http://192.168.137.49:31531/videostream.cgi?user=admin&pwd=TApop123')
    ...
    while(cap.isOpened()):
        ...
        for j in list_of_classes:
            ...
            if(check != free): #Free Change
                ...
                conn.commit()
                #cv2.imwrite('D://User//Test//ProjectParkingDetection//CapImg//Picture_{}_{}.jpg'.format(pic,free),img)
                #pic+=1
                print("Before Check: ",check)
                check = free
                print("After Check: ",check)
            #if change from 10 to less go line
